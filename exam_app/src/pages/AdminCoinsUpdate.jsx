...
export default function AdminCoinsUpdate() {
    ...
    const getSingleUserData = async () => {
        try {
            const response = await fetch(`${BACKEND_HOSTING_URL}/api/admin/requests/${params.email}`, {
                method: 'GET',
                headers: {
    ...
    const handleSubmitUser = async (evt) => {
        ...
        try {
            const response = await fetch(`${BACKEND_HOSTING_URL}/api/admin/requests/update/${params.email}`, {
                method: 'PATCH',
                headers: {
